...
class Settings:
    ...
    auto_prune_interval_hours: int = int(os.getenv("AUTO_PRUNE_INTERVAL_HOURS", "24"))
    outbound_proxy: str = os.getenv("OUTBOUND_PROXY", os.getenv("HTTP_PROXY", ""))
    no_proxy: str = os.getenv("NO_PROXY", "127.0.0.1,localhost,.local")
